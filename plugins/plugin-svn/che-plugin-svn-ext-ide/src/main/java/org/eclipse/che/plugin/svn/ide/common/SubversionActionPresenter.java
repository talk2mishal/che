...
public class SubversionActionPresenter {
     ...
     * the operation wil be recalled with requested credentials
     *
     * @param notification
     *         progress notification that was notified when operation started
     */
    protected <Y> Promise<Y> performOperationWithCredentialsRequestIfNeeded(final SVNOperation<Y> operation,
                                                                            final StatusNotification notification) {
        return operation.perform(new Credentials())
