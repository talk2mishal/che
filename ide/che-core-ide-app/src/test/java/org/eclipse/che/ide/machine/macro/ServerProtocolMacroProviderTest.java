...
public class ServerProtocolMacroProviderTest {
    ...
    public void setUp() throws Exception {
        provider = new ServerProtocolMacroProvider(commandMacroRegistry, eventBus, appContext);
    ...
    public void getMacroProviders() throws Exception {
        ...
        assertEquals(provider1.getName(), ServerProtocolMacroProvider.KEY.replace("%", WS_AGENT_PORT));
        ...
        assertEquals(provider2.getName(), ServerProtocolMacroProvider.KEY.replace("%", WS_AGENT_PORT.substring(0, WS_AGENT_PORT.length() - 4)));
