...
public class ServerMacroProviderTest {
    ...
    public void setUp() throws Exception {
        provider = new ServerMacroProvider(commandMacroRegistry, eventBus, appContext);
    ...
    public void getMacroProviders() throws Exception {
        ...
        assertEquals(provider1.getName(), ServerMacroProvider.KEY.replace("%", WS_AGENT_PORT.substring(0, WS_AGENT_PORT.length() - 4)));
        ...
        assertEquals(provider2.getName(), ServerMacroProvider.KEY.replace("%", WS_AGENT_PORT));
